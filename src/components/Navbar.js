...
const Navbar = ({toggle}) => {
  return (
    <nav className='flex justify-between' role='navigation'> 
      <button className='font-nav pl-4 pr-4 text-xl bg-clip-text hover:text-transparent bg-gradient-to-br from-green-700 to-indigo-600'>
        Kenneth Harris
      </button>
      <h1 className='md:block hidden pt-2 pb-2 pr-2 items-center font-sans'>
        ...
        <Link to="/" className='px-4 text-base font-nav bg-clip-text hover:text-transparent bg-gradient-to-br from-green-400 to-blue-500'> 
          Projects
        </Link>
